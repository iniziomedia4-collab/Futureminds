...
(function () {
  ...
  function renderFooter(site) {
    ...
    return '<footer class="footer"><div class="container">' +
      ...
      '<div class="footer-bottom"><span>&copy; ' + new Date().getFullYear() + ' ' + esc(site.brand.name) + '. All rights reserved. &middot; Bengaluru, India</span><span>' + esc(f.accreditations) + '</span></div>' +
      '</div></footer>';
  }
  ...
  var PAGES = {
    ...
    'global-partnerships': function (d) {
      ...
      var hero = '<header class="page-hero"><div class="glow"></div><div class="container"><div class="gp-hero-grid"><div class="page-hero-inner reveal" style="max-width:none">' +
        ...
        '</div></div><div class="gp-hero-media reveal"><img src="img/sections/1.3.png" alt="Representatives from education, healthcare and international institutions in collaborative discussion" loading="eager" decoding="async"></div></div></div></header>';
      ...
      var hc = '<section class="section ink"><div class="container"><div class="gp-split">' +
        '<div class="gp-media reveal"><img src="img/sections/1.1.png" alt="Nurses and healthcare professionals engaged in patient communication, teamwork and clinical coordination" loading="lazy" decoding="async"></div>' +
        '<div>' + sectionHead(g.healthcare.eyebrow, g.healthcare.title) +
      ...
      var how = '<section class="section paper" id="how-we-partner"><div class="container">' +
        '<div class="gp-split" style="margin-bottom:44px">' +
        '<div class="gp-media reveal"><img src="img/sections/1.2.png" alt="Faculty, institutional leaders and professionals engaged in collaborative planning, training and knowledge exchange" loading="lazy" decoding="async"></div>' +
        '<div class="reveal"><span class="eyebrow">' + esc(g.howWePartner.eyebrow) + '</span><h2 style="margin:14px 0 8px">' + esc(g.howWePartner.title) + '</h2></div>' +
        '</div>' +
        '<div class="grid-3">' + steps + '</div></div></section>';
